...
const LEVELS=[
  ...
  {name:'THE CHICKEN COOP', theme:'coop', bg:'#8acbd5', floor:'#73523b', width:1800, plats:5, total:14, poison:1, bomb:2, tough:[12,22], floatC:.4, layout:'stairs', reward:90},
  {name:'GOLDEN FIELDS', theme:'field', bg:'#a8dfe1', floor:'#526d3b', width:2150, plats:6, total:18, poison:2, bomb:2, tough:[18,30], floatC:.5, layout:'scatter', reward:160},
  {name:'FEATHERPEAK MOUNTAIN', theme:'mountain', bg:'#96b2cd', floor:'#555b72', width:2350, plats:8, total:18, poison:2, bomb:3, tough:[24,38], floatC:.55, layout:'tiers', reward:130},
  {name:'THE VOLCANO • JACKPOT RUN', theme:'volcano', bg:'#482f4e', floor:'#332735', width:2500, plats:9, total:16, poison:0, bomb:15, tough:[16,24], floatC:.5, layout:'stairs', reward:160, jackpot:true},
